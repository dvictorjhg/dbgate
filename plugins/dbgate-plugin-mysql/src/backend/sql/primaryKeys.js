module.exports = `select 
	TABLE_CONSTRAINTS.CONSTRAINT_SCHEMA as Db,
...
where (TABLE_CONSTRAINTS.CONSTRAINT_SCHEMA = '#DATABASE#' OR '#DATABASE#' = 'undefined') and TABLE_CONSTRAINTS.TABLE_NAME =OBJECT_ID_CONDITION AND TABLE_CONSTRAINTS.CONSTRAINT_TYPE = 'PRIMARY KEY'
